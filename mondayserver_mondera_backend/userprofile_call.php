...
$teamid = strip_tags($_GET['teamid_issue']);
$userid = strip_tags($_GET['userid_issue']);

$res1 = $db->prepare("SELECT * FROM users WHERE team_identity =:team_identity and id=:id");
$res1->execute(array(':team_identity' =>$teamid, ':id' => $userid));
