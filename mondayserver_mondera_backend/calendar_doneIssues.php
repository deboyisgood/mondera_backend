...
if(!empty($_GET['uid']))  $uid = strip_tags($_GET['uid']);
	...
	$calendar .= "<div class='panel-heading text-center'><div class='row'><div class='col-md-3 col-xs-4'><a title='previous' class='calendar_calling3 btn btn-default btn-sm' href='http://localhost/microsoft_school_upload/monday_db/calendar_doneIssues.php?month=".$prev_month."&year=".$prev_year."&teamid=".$teamid."'><span class='glyphicon glyphicon-arrow-left'></span></a></div><div class='col-md-6 col-xs-4'><strong>" . date("F Y", $date) . "</strong></div>";
	$calendar .= "<div class='col-md-3 col-xs-4 '><a title='Next' class='calendar_calling3 btn btn-default btn-sm' href='https://qbtut.com/mondayserver/calendar_doneIssues.php?month=".$next_month."&year=".$next_year."&teamid=".$teamid."'><span class='glyphicon glyphicon-arrow-right'></span></a></div></div></div>"; 
...
$result = $db->prepare("SELECT * from issues where issue_month = :issue_month and team_id =:team_id and status='Done' ");		
